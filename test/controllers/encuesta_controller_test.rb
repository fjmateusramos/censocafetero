...
class EncuestaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create encuestum" do
    assert_difference('Encuestum.count') do
      post encuesta_url, params: { encuestum: { fecha: @encuestum.fecha, hora: @encuestum.hora } }
    end
  ...
  test "should update encuestum" do
    patch encuestum_url(@encuestum), params: { encuestum: { fecha: @encuestum.fecha, hora: @encuestum.hora } }
